...
const blocks: Block[] = [
  ...
  },
  {
    ...
    outro: "De boer die in 1940 wachtte, ploegde in 1945 nog met ossen. En jij?",
  },
];
    ...
    <div style={{ maxWidth: "880px" }}>
      ...
      {block.stat && (
        <div
          style={{
            ...
            marginBottom: "12px",
            textShadow:
              "0 0 30px rgba(245, 241, 232, 0.35), 0 0 60px rgba(74, 127, 196, 0.25)",
          }}
        >
          {block.stat}
        </div>
      ...
      <h2
        style={{
          ...
          whiteSpace: "pre-line",
          textShadow:
            "0 0 24px rgba(245, 241, 232, 0.3), 0 0 48px rgba(74, 127, 196, 0.2)",
        }}
      >
        {block.title}
      </h2>

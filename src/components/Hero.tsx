...
const T = {
  nl: {
    ...
    sub: "Je werkt voor je bedrijf, maar veel tijd gaat naar werk dat een computer ook kan doen. Wij bouwen AI-automatiseringen die dat overnemen, in jouw eigen tools.",
  ...
  en: {
    ...
    sub: "You work for your business, but a lot of time goes into work a computer could do too. We build AI automations that take it over, inside your own tools.",
